...
1. Use prefix sums for the <code>x</code>-coordinate and <code>y</code>-coordinate.
2. Using the prefix sum arrays, compute the <code>x</code>-coordinate and <code>y</code>-coordinate after removing a subarray of size <code>k</code>.
